...
A curva de notificação de dengue, ao nível de país, segue mantendo o padrão acima do diagrama de controle, com leve tendência de aumento desde a semana 44, atingindo um máximo de transmissão na semana 47 (Rt = 1,14) e uma desaceleração nas últimas 2 semanas. A chikungunya apresenta tendência de aumento desde a semana 46 (Rt entre 1,1 e 1,26) e estima-se que esteja acima do canal endêmico desde a semana 41. 
...
As curvas de incidências estimadas para chikungunya na SE 49, em todo o país, estão abaixo do observado no ano de 2023. Ainda assim, observa-se um padrão de atividade aumentada, acima do limiar epidêmico, no MS, que se mantém desde a temporada anterior. Em SP e MG, observa-se um aumento mais recente, sendo que SP está com alerta por passar o limiar epidêmico. O modelo indicou crescimento súbito da curva de casos estimados no MT, na última semana, a acompanhar, podem ser mudanças no padrão de notificação ou instabilidade do modelo. 
