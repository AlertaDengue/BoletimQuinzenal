...
A tabela abaixo mostra as macrorregionais que apresentaram nível de incidência médio ou alto, para dengue e Chikungunya.

\begin{center}
\includegraphics{tabela_nivel_incidencia}
\end{center}
...
\begin{center}
\includegraphics{tabela_nivel_incidencia2}
\end{center}
