...
<!-- Texto humano -->
\begin{itemize}
\item Crescimento das incidências de dengue estimadas no Amapá, em especial na regional Área sudoeste. 
\item Santa Catarina e Paraná seguem em aumento da incidência e taxas de reprodução dos casos de dengue. Santa Catarina em especial no momento segue acima do limiar epidêmico;
\item Distrito Federal com aumento da taxa de reprodução de casos de dengue a monitorar;
\item São Paulo com incidências estáveis para dengue, embora persistentes, especialmente na região de São José do Rio Preto.
\end{itemize}
...
A curva de notificação de dengue, ao nível de país, segue mantendo o padrão acima do diagrama de controle, porém com tendência de estabilidade. Já para chikungunya, a incidência atual está um pouco acima dos canais endêmicos, embora com leve tendência de queda no momento. 
...
Na região Norte é possível evidenciar um aumento dos casos estimados de dengue no Amapá, a monitorar se a curva de casos notificados acompanhará a tendência. Acre, embora estável no momento, apresentou aumento nas últimas 4 semanas, o que deve ser acompanhado. Roraima apresenta leve tendência de aumento da incidência.

Na região nordeste, as curvas encontram-se dentro do padrão para o observado histórico, na maioria dos estados. Todos os estados se encontram estáveis ou em queda na semana 46. Piauí, Paraíba, Bahia e Pernambuco com incidências estimadas acima dos canais endêmicos.

No centro oeste, o cenário é de queda da curva de incidência de casos estimados para Mato Grosso, Goiás, e Distrito Federal, porém acima dos canais epidêmicos. Mato Grosso do sul com curvas dentro dos canais endêmicos. 

O cenário do sudeste é tendência de queda em todos os estados observáveis.  Em SP e RJ vale a pena observar que apesar de uma tendência de queda no momento, as curvas se encontram com um nível de incidência estimada bem acima dos canais endêmicos. 

No sul, Paraná e Santa Catarina apresentam cenário de queda na incidência estimada entre a semana 46 e a anterior. Todavia, as incidências estimadas seguem altas, com  Santa Catarina ultrapassando o limiar epidêmico calculado. Rio Grande do sul também apresenta incidências calculadas mais altas que as observadas no ano passado, com valores acima dos canais endêmicos.
...
As curvas de incidências estimadas para chikungunya na SE 46, em todo o país, estão abaixo do observado no ano de 2023. Mato Grosso do Sul segue com  valores estimados acima do limiar epidêmico há várias semanas.
...
*Acre:* o padrão de crescimento persiste, mas com uma taxa de reprodução dos casos menor que nas últimas 3 semanas, estimada em 12% nas últimas 3 semanas. 
Amapá: crescimento da notificação com crescimento de 19% nas últimas 3 semanas.  
*Distrito Federal:* Taxa de reprodução evidenciando claro crescimento dos casos, chegando a 1,44 nas últimas três semanas. É importante estar atento a esta UF, dado o histórico de rápido crescimento nos casos da última temporada;

*Santa Catarina:* Estima-se uma taxa de reprodução foi 1,07 nas últimas 3 semanas. 
...
Alguns casos específicos  a se observar é o município de Iconha, no ES, que registrou uma alta incidência de casos de chikungunya na última semana, e o Triangulo do Norte e Zona da Mata que  estão com alta incidência e seguem com tendência de subida.
...
O Infodengue, em parceria com o Mosqlimate, gerou previsões para a temporada 2024-2025 de dengue no país, por UF (https://zenodo.org/records/13929005). Para cada estado, tem-se dois modelos ensemble, que representam cenários de maior ou menor incidência. Importante ressaltar que a figura à esquerda representa um "zoom" da imagem à direita.

Para o ensemble de curto prazo, foram empregados três modelos distintos: o primeiro é baseado em redes neurais LSTM, o segundo utiliza processos gaussianos, e o último é um modelo ARIMA não sazonal e univariado. Esses modelos foram aplicados aos casos prováveis a nível de Unidade da Federação (UF) no Brasil, sendo treinado um modelo para cada UF e outro para o Brasil como um todo.

Para a correção da curva de casos prováveis, foi assumido que esta é proporcional à curva dos casos notificados estimados pelo nowcasting. A proporção foi calculada com base na relação histórica entre essas curvas nos últimos seis meses, excluindo-se as últimas dez semanas devido ao atraso de notificação ainda presente nesse período.

Nas figuras de previsão (forecast), o painel à esquerda apresenta um zoom com o objetivo de destacar as previsões de curto prazo, enquanto o painel à direita foca em comparar a tendência de curto prazo prevista com as tendências projetadas pelos modelos de ensemble de longo prazo propostos.
